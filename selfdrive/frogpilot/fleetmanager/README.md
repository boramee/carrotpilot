...
## Carrot FTP upload configuration

Fleet Manager can upload selected route segments via FTP. Configure your server using either
Params keys or environment variables:

- `CarrotFtpHost` / `CARROT_FTP_HOST`
- `CarrotFtpPort` / `CARROT_FTP_PORT` (default: 21)
- `CarrotFtpUser` / `CARROT_FTP_USER`
- `CarrotFtpPassword` / `CARROT_FTP_PASSWORD`
- `CarrotFtpBaseDir` / `CARROT_FTP_BASE_DIR` (default: routes)
