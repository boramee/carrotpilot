...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  latLongToggles->addItem(new CValueControl("SoftStopEnable", tr("LONG: SoftStop (0)"), tr("0:Off, 1:On"), 0, 1, 1));
  latLongToggles->addItem(new CValueControl("SoftStopSpeed1", tr("LONG: SoftStop Speed1(10km/h)"), tr("Stage2 start speed"), 2, 20, 1));
  latLongToggles->addItem(new CValueControl("SoftStopSpeed2", tr("LONG: SoftStop Speed2(5km/h)"), tr("Stage3 start speed"), 1, 15, 1));
  latLongToggles->addItem(new CValueControl("SoftStopAccel2", tr("LONG: SoftStop Accel2 x0.01(-50)"), tr("Stage2 target accel"), -100, 0, 5));
  latLongToggles->addItem(new CValueControl("SoftStopAccel3", tr("LONG: SoftStop Accel3 x0.01(-20)"), tr("Stage3 target accel"), -100, 0, 5));
